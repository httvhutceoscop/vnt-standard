...
<p class="easy_faqs_registered">Your plugin is succesfully registered and activated!</p>
<?php else: ?>
...
<p class="easy_faqs_not_registered">Your plugin is not succesfully registered and activated. <a href="https://goldplugins.com/our-plugins/easy-faqs-details/upgrade-to-easy-faqs-pro/?utm_source=registration_fields" target="_blank">Click here</a> to upgrade today!</p>
<?php endif; ?>	
...
<table class="form-table">
	...
	?>
		<tr valign="top">
			...
			<td><input type="password" name="easy_faqs_registered_key" id="easy_faqs_registered_key" value="<?php echo get_option('easy_faqs_registered_key'); ?>"  style="width: 250px" />
